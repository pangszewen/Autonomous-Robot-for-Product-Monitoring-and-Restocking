...
class NavToPoint:
    def __init__(self):
        ...
        self.locations = {
            'shelf': Pose(Point(0.13463953048307326, -1.12668678437189, 0), Quaternion(0, 0, -0.03738627039031071, 0.9993008890150666)),
            'storage': Pose(Point(-0.4220066261350548, -1.9153227696420967, 0), Quaternion(0, 0, -0.7142109655783565, 0.6999304941546922)),
            'home': Pose(Point(-1.140485621847589, -0.08266005005955564, 0), Quaternion(0, 0, -0.06483197219789898, 0.9978961946920786))
        }
